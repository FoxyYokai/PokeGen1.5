...
; Characteristics of each move.
	...
	move MEGA_PUNCH,   DEFENSE_DOWN_SIDE_EFFECT,   100, FIGHTING,      90,  5
	...
	move RAZOR_WIND,   CHARGE_EFFECT,              140, NORMAL,        95, 10
	...
	move FLY,          FLY_EFFECT,                  95, FLYING,        95, 15
	move BIND,         TRAPPING_EFFECT,             18, NORMAL,        80, 20
	move SLAM,         DEFENSE_DOWN_SIDE_EFFECT,    85, NORMAL,        80, 20
	move VINE_WHIP,    NO_ADDITIONAL_EFFECT,        40, GRASS,        100, 20
	move STOMP,        FLINCH_SIDE_EFFECT2,         65, NORMAL,       100, 20
	move DOUBLE_KICK,  ATTACK_TWICE_EFFECT,         30, FIGHTING,     100, 30
	move MEGA_KICK,    DEFENSE_DOWN_SIDE_EFFECT,   120, FIGHTING,      85,  5
	move JUMP_KICK,    JUMP_KICK_EFFECT,            75, FIGHTING,      95, 25
	move ROLLING_KICK, FLINCH_SIDE_EFFECT2,         65, FIGHTING,     100, 15
	...
	move TWINEEDLE,    TWINEEDLE_EFFECT,            40, POISON,       100, 20
	...
	move POISONPOWDER, POISON_EFFECT,                0, POISON,        90, 30
	...
	move ROCK_THROW,   NO_ADDITIONAL_EFFECT,        50, ROCK,          95, 20
	...
	move WATERFALL,    FLINCH_SIDE_EFFECT1,        100, WATER,        100, 15
	...
	move SPIKE_CANNON, TWO_TO_FIVE_ATTACKS_EFFECT,  25, ICE,		  100, 15
	move CONSTRICT,    SPEED_DOWN_SIDE_EFFECT,      30, GRASS,        100, 35
	move AMNESIA,      SPECIAL_UP2_EFFECT,           0, PSYCHIC_TYPE, 100, 20
	move KINESIS,      ACCURACY_DOWN2_EFFECT,        0, PSYCHIC_TYPE,  95, 15
	move SOFTBOILED,   HEAL_EFFECT,                  0, NORMAL,       100, 10
	move HI_JUMP_KICK, JUMP_KICK_EFFECT,           120, FIGHTING,      80, 20
	move GLARE,        PARALYZE_EFFECT,              0, NORMAL,       100, 20
	move DREAM_EATER,  DREAM_EATER_EFFECT,         100, GHOST,        100, 15
	move POISON_GAS,   POISON_EFFECT,                0, POISON,        95, 20
	move BARRAGE,      TWO_TO_FIVE_ATTACKS_EFFECT,  20, GRASS,         85, 20
	...
	move ROCK_SLIDE,   FLINCH_SIDE_EFFECT1,			85, ROCK,          95, 15
	move HYPER_FANG,   FLINCH_SIDE_EFFECT1,         85, NORMAL,        95, 15
	...
	move DRAGONCLAW,   NO_ADDITIONAL_EFFECT,       100, DRAGON,       100, 10
	...
	move AERIALACE,    SWIFT_EFFECT,                70, FLYING,       100, 20
	...
	move POISONFANG,   PARALYZE_SIDE_EFFECT2,       60, POISON,       100, 15
	move SLUDGEBOMB,   POISON_SIDE_EFFECT1,         90, POISON,       100, 10
	move ROCKBLAST,    TWO_TO_FIVE_ATTACKS_EFFECT,  22, ROCK,          90, 10
	move TOMBSTONER,   FLINCH_SIDE_EFFECT2,        130, ROCK,          75,  5
	move MUDSLAP,	   ACCURACY_DOWN_SIDE_EFFECT,   35, GROUND,       100, 25
	move BULLDOZE,     SPEED_DOWN_SIDE_EFFECT,      75, GROUND,       100, 20
	move WHIRLPOOL,    CONFUSION_SIDE_EFFECT,		75, WATER,        100, 15
	move CRUNCH,	   DEFENSE_DOWN_SIDE_EFFECT,    95, NORMAL,		  100, 10
	move CHARGE,	   SPECIAL_UP1_EFFECT,			 0, ELECTRIC,	  100, 20
	move FAKE_TEARS,   SPECIAL_DOWN1_EFFECT,		 0, NORMAL,		  100, 30
	move EERIE_NOISE,  SPECIAL_DOWN2_EFFECT,		 0, GHOST,		  100, 20
	move PSYSTRIKE,    PARALYZE_SIDE_EFFECT2,	   120, PSYCHIC_TYPE,  90,  5
