ViridianCity_Object:
	...
	bg_event 19, 25, 10 ; ViridianCityText10
	bg_event 30, 19, 11 ; MartSignText
	bg_event 24, 25, 12 ; PokeCenterSignText
	bg_event 27,  5, 13 ; ViridianCityText13

	def_object_events
	object_event 13, 20, SPRITE_YOUNGSTER, WALK, ANY_DIR, 1 ; person
	object_event 30,  6, SPRITE_GAMBLER, STAY, NONE, 2 ; person
	object_event 30, 28, SPRITE_YOUNGSTER, WALK, ANY_DIR, 3 ; person
